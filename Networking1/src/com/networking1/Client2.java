...
public class Client2 extends Activity {
  ...
  /**size: para exibir a quantidade de estudantess cadastrados**/
  class SizCmd extends AbstractCommand implements Command,  
  	  Button.OnClickListener {
	public void execute(Dao6 d) {
	  String strId = txtId.getText().toString();
	  long id = Long.parseLong(strId);
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    ((Button) findViewById(R.id.siz)).setOnClickListener(new SizCmd());/**size**/
